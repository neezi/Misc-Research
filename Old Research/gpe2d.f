...
*************************************** DEFINITION OF VARIABLES***************************************************
      ...
      double precision    N,N_old,N_diff,R                       !! Variables for the particle number N, 
...
** REAL TIME OPERATIONS:
	    ...
	    call get_X(psi,R,xmax)		                        !! Determine average position
            write(*,*)'t=',real(t),'X=',real(R)/real(N),'E=',real(E)
      ...
      do i=1,Nx                                             !! Loop over x-indices
       ...
       do j=1,Ny                                            !! Loop over y-indices.
         y=-ymax+dble(j-1)*dy                               !! Generates y-position at each index.
         		                    ...
         		                    !! Example: for t=0 we impose a harmonic trap
           V(i,j)=2.0*x**2 - 1.0*Exp(-1.0*(x+0.1*t - 40.0)**2)                   !! offset in x; then for t>0 we move the trap to the centre.
